...
try:
    ...
    st.header(stock_name + "キャンドルステック") 
    ...
    # Machine Learning
        ...
        # Display confidence level based on accuracy
        if accuracy > 0.75:
            st.write('信頼度：高')
        elif accuracy > 0.5:
            st.write('信頼度：中')
        ...
        # Verification using prediction data
...
st.write('copyright © 2021 Arafat Sarker All Rights Reserved')    
